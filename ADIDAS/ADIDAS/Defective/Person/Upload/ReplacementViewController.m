...
@interface ReplacementViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    [self.listTableView registerNib:[UINib nibWithNibName:@"DressPicTableViewCell" bundle:nil] forCellReuseIdentifier:@"DressPicTableViewCell"];
