...
- (void)commonInit
{
    ...
    
    {
        ...
        _dotRightView.backgroundColor = [UIColor greenColor];
...
- (void)layoutSubviews
{
    ...
    _dotLeftView.center = CGPointMake((self.frame.size.width / 2.)-5, (self.frame.size.height / 2.) +sizeDot * 2.5);
    _dotLeftView.layer.cornerRadius = sizeDot / 2.;
    
    _dotRightView.frame = CGRectMake(0, 0, sizeDot, sizeDot);
    _dotRightView.center = CGPointMake((self.frame.size.width / 2.)+5, (self.frame.size.height / 2.) +sizeDot * 2.5);
