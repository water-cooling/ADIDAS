...
- (void)viewDidLoad {
    ...
    self.colorPan.frame = CGRectMake([UIScreen mainScreen].bounds.size.width - 60, ([UIScreen mainScreen].bounds.size.height-self.colorPan.bounds.size.height)/2.0, self.colorPan.bounds.size.width, self.colorPan.bounds.size.height);
