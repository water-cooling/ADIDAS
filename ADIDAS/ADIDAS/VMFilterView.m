...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        self.countLabel = [[UILabel alloc] initWithFrame:CGRectMake(7, 7, 22, 25)];
        ...
        imageview.image = [UIImage imageNamed:SYSLanguage?@"VMfilter_en.png": @"VMfilter.png"];
