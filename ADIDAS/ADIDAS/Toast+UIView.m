...
static const NSString * CSToastDefaultTopPostion = @"top";
...
- (void)makeToast:(NSString *)message {
    ...
    [self makeToast:message duration:10 position:CSToastDefaultTopPostion];
}
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    wrapperView.backgroundColor = [UIColor colorWithRed:0.2f
                                                  green:0.2f
                                                   blue:0.2f
                                                  alpha:0.75f];
